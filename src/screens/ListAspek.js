...
export default function ListAspek() {
  ...
  const handleList1 = async () => {
    ...
    const resList1 = await Axios.get(`${API_URL}/api/list/cv_rpd_aspek`).then(res => res.data.cv_rpd_aspek);
              ...
              <div className="flex flex-wrap items-stretch">
                {dataList1.map((item, key) => 
                    <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                      ...
                      <a href= {'listFokus/' + item.aspek_id } className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500 overflow-hidden">
