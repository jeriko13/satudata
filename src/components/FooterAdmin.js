        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full px-4">
              <div className="text-sm text-blueGray-500 font-semibold py-1 md:text-left">
                Copyright © {new Date().getFullYear()}{" "}Dinas Komunikasi dan Informatika Kabupaten Banjarnegara
              </div>
            </div>
